            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-700">
              ...
              <div className="inline-flex p-1 bg-slate-950 rounded-2xl border border-slate-800 self-start sm:self-center">
                <button
                  ...
                  className={
                    !adminModeActive
                      ? 'px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 cursor-pointer bg-slate-800 text-white shadow-sm'
                      : 'px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 cursor-pointer text-slate-400 hover:text-white'
                  }
                >
                ...
                <button
                  ...
                  className={
                    adminModeActive
                      ? 'px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 cursor-pointer bg-cyan-600 text-white shadow-md shadow-cyan-600/30'
                      : 'px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 cursor-pointer text-slate-400 hover:text-white'
                  }
                >
            ...
            {adminModeActive && (
              <div className="space-y-4 pt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-80 overflow-y-auto pr-2">
                  {Object.keys(siteTexts).map((textKey) => (
                    <div key={textKey} className="p-3 bg-slate-950/70 border border-slate-800 rounded-xl space-y-1">
                      <span className="text-[10px] text-cyan-400 font-mono block truncate">
                        {textKey}
                      </span>
                      <input
                        type="text"
                        value={siteTexts[textKey]}
